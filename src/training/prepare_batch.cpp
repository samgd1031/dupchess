...
DLLEXPORT int feature_index(int ksq, int sq, int piece_type, int color) {
...
/// <returns></returns>
DLLEXPORT int features_from_fen(char* fen_c, int* f_indexes, float* values, int king_color){
